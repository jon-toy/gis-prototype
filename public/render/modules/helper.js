...
function displayParcel(feature) {
  document.getElementById("parcel-num-display").innerHTML =
    "Parcel Number: " + feature.getProperty("PARCEL_NUM");
}
...
function displayMarker(feature) {
  document.getElementById("parcel-num-display").innerHTML =
    "Address: " +
    feature.getProperty("NUMBER1") +
    " " +
    feature.getProperty("NUMBER0");
}
...
var LOCAL_STORAGE_KEY_ROADS_FT = "roads-ft";
var LOCAL_STORAGE_KEY_TEXT_FT = "text-ft";
